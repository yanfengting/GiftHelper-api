...
var swiperModel = mongoose.model('swiper', swiperSchma, 'swiper');
...
var nvyouModel = mongoose.model('nvyou', nvyouSchma, 'nvyou');
var zhangbeiModel = mongoose.model('zhangbei', zhangbeiSchma, 'bamas');
var babyModel = mongoose.model('baby', babySchma, 'babies');
var giftModel = mongoose.model('gift', giftSchma, 'gift');
var cyshModel = mongoose.model('cysh', cyshSchma, 'cyshs');
var qpggModel = mongoose.model('qpgg', qpggSchma, 'qpgg');
var kjfModel = mongoose.model('kjf', kjfSchma, 'kjf');
var mmdModel = mongoose.model('mmd', mmdSchma, 'mmd');
var sjgModel = mongoose.model('sjg', sjgSchma, 'sjg');
var wyfModel = mongoose.model('wyf', wyfSchma, 'wyf');
